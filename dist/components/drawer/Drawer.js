...
import './Drawer.css';
export const Drawer = ({ open, setOpen, formOne, formTwo, background, width = 50 + '%', column = true, paperColor = 'transparent', }) => {
        ...
        React.createElement("div", { className: "box", style: { backgroundColor: paperColor } },
            React.createElement("div", { className: open ? `drawer-open` : `drawer-close`, 
                ...
                React.createElement("div", null,
                    React.createElement("button", { onClick: () => setOpen(!open) }, "x")),
